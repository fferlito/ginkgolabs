          ...
          <SubscriptionDetailsButton
            subscriptionDetailsProps={{
              appearance: {
                variables: {
                  colorPrimary: "#4A7C5D",
                  colorPrimaryForeground: "#F5F5F0",
                  colorBackground: "#1B3022",
                  colorForeground: "#F5F5F0",
                  colorMutedForeground: "#B5C0B8",
                  colorMuted: "#243D2E",
                  colorInput: "#243D2E",
                ...
                elements: {
                  card: "bg-[#1B3022] text-[#F5F5F0]",
                  headerTitle: "text-[#F5F5F0]",
                  headerSubtitle: "text-[#B5C0B8]",
                  formFieldLabel: "text-[#B5C0B8]",
                  formFieldInput: "bg-[#243D2E] text-[#F5F5F0] border-[#2D5F3F]",
                  "clerk-accordionTrigger": "text-[#F5F5F0]",
                  "clerk-badge": "text-[#F5F5F0]",
                },
              },
            }}
